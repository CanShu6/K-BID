...
def parse_sur_args():
    parser = argparse.ArgumentParser(description="Run SUR.")
    ...
    parser.add_argument('--mode', type=int, default=0,
                        help='0: train, 1: predict, 2:save embeddings')
    ...
    parser.add_argument('--social_batch_size', type=int, default=1024,
                        help='Social batch size.')
    ...
    parser.add_argument('--social_l2loss_lambda', type=float, default=1e-5,
                        help='Lambda when calculating social l2 loss.')
    ...
    parser.add_argument('--use_polling', type=int, default=1)
    parser.add_argument('--occupy_mem_ratio', type=float, default=0.7)

    args = parser.parse_args()

    save_dir = 'trained_model/SUR/{}/embed-dim{}_{}_{}_{}_lr{}_pretrain{}/'.format(
        args.data_name, args.embed_dim, args.laplacian_type, args.aggregation_type,
