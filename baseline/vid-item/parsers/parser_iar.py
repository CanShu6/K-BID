...
def parse_iar_args():
    parser = argparse.ArgumentParser(description="Run IAR.")
    ...
    save_dir = 'trained_model/IAR/{}/embed-dim{}_relation-dim{}_{}_{}_{}_lr{}_pretrain{}/'.format(
